...
function initSlickCarousel() {
    ...
    jQuery('.special-offers-slider').slick({
        slidesToScroll: 1,
        rows: 0,
        slidesToShow: 4,
    ...
    jQuery('.product-secondary-slider').slick({
        slidesToScroll: 1,
        slidesToShow: 4,
        centerMode: true,
        rows: 0,
...
function initOpenClose() {
    ResponsiveHelper.addRange({
        '1024..': {
            ...
            off: function() {
                jQuery('.search-box').openClose('destroy');
            }
        }
    });
}

function initZoomMaster() {
    ResponsiveHelper.addRange({
        '1024..': {
            on: function() {
                jQuery('.product-slide-item').zoom();
            },
            off: function() {
                jQuery('.product-slide-item').openClose('destroy');
            }
        }
    });
}
